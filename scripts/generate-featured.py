...
entries = [
    ...
    curated(9000004, "白菊", "しらぎく", "Shiragiku",
        ...
        "白一色で静かに開く慰霊の花火。花火師・嘉瀬誠次氏がシベリア抑留の戦友に捧げたことに始まり、8月1日の平和祭の夜と、両日の大花火大会の冒頭を飾る。",
        "白一色で開く慰霊の花火。8月1日の夜と、両日の大会冒頭に静かに打ち上げられる。",
        "The Shiragiku is a pure-white memorial shell first fired by pyrotechnician Seiji Kase in mourning for comrades lost in Siberian internment. It is launched on the night of August 1st and at the opening of both fireworks nights.",
        "A pure-white memorial shell fired on the night of August 1st and at the opening of both fireworks nights.",
